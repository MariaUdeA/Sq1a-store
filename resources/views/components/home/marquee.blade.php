...
>
    ...
    <div
        x-ref="marqueeTrack"
        class="animate-full-tl rtl:animate-full-tr relative flex flex-row w-full gap-10"
        x-bind:class="{ 'hover:[animation-play-state:paused]': pauseOnHover }"
    >
        <!-- Marquee list -->
        <div
            x-ref="marqueeList"
            class="flex w-auto flex-shrink-0 flex-nowrap items-center justify-around gap-10"
        >
            <!-- Marquee Items -->
            <!--
